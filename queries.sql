...
--Salaries by decending order by to_date
SELECT * FROM salaries
ORDER BY to_date DESC;

--Create a new table with employees information
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
--Employees list by department info
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
...
--Employee info from sales department
SELECT * from dept_info
where dept_name = 'Sales';

--Employee info from sales and development department
SELECT * from dept_info
